...
import g1 from "@/assets/gallery/hackathon-win.jpg";
import g2 from "@/assets/gallery/speaking.jpg";
import g3 from "@/assets/gallery/workshop.jpg";
import g4 from "@/assets/gallery/award.jpg";
import g5 from "@/assets/gallery/content.jpg";
import g6 from "@/assets/gallery/team.jpg";
import g7 from "@/assets/gallery/aspire.jpg";
import g8 from "@/assets/gallery/outreach.jpg";

const photos = [
  { src: g1, title: "Lazarus 2.0 — Winning Moment", tag: "Hackathon" },
  { src: g2, title: "Speaking at a Tech Meetup", tag: "Speaking" },
  { src: g3, title: "Community Workshop, Trincomalee", tag: "Workshop" },
  { src: g4, title: "Certificate Presentation", tag: "Award" },
  { src: g5, title: "Behind the Scenes — Content", tag: "Content" },
  { src: g6, title: "Team & Volunteers", tag: "Team" },
  { src: g7, title: "Aspire Leaders Program", tag: "Program" },
  { src: g8, title: "Youth Outreach Program", tag: "Outreach" },
];

// Masonry span pattern for visual rhythm
const spans = [
